-- better-auth default Kysely adapter uses camelCase column names.
-- 001_auth.sql created snake_case by mistake — rename here.
-- Idempotent via conditional rename so fresh installs from a future
-- 001_auth.sql rewrite also work.
