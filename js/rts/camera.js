...
const S = {
  ...
  darkness: {player:0, enemy:0},
  light:    {player:0, enemy:0},
...
function resetRtsState(){
  ...
  S.gold={player:0, enemy:0}; S.oil={player:0, enemy:0};
  S.darkness={player:0, enemy:0}; S.light={player:0, enemy:0};
  S.baseHP=150; S.enemyBaseHP=150;
