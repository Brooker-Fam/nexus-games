...
// ── DARKNESS / LIGHT GENERATORS ──
function makeDarknessGenerator(side, faction, x, y){
  return {
    id:nextId(), type:'structure', side, faction,
    x, y, hp:80, maxHp:80,
    structType:'darknessgen',
    selected:false, frame:0,
    label:'DARKNESS GEN', isDarknessGen:true,
    darkness:200, maxDarkness:200,
    underConstruction:true, buildProgress:0, buildTime:BUILD_TIMES.structure,
  };
}
function makeLightGenerator(side, faction, x, y){
  return {
    id:nextId(), type:'structure', side, faction,
    x, y, hp:80, maxHp:80,
    structType:'lightgen',
    selected:false, frame:0,
    label:'LIGHT GEN', isLightGen:true,
    light:200, maxLight:200,
    underConstruction:true, buildProgress:0, buildTime:BUILD_TIMES.structure,
  };
}
