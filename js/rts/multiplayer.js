...
function myDarkness(){ return S.darkness[mySide()]||0; }
function myLight(){ return S.light[mySide()]||0; }
...
function mpCheckStart(){
  ...
  if(mpIsHost){
    const msg={t:'go',hf:mpLocalFaction,gf:mpRemoteFaction,ver:MP_VERSION};
